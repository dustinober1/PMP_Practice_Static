#!/usr/bin/env python3
"""
Script to process AgilePracticeGuide.md and properly separate combined definitions that were joined together
and ensure each definition has a bullet point.
"""
...
def fix_definitions(input_file, output_file):
    """
    Process the input file to properly separate combined definitions and add bullet points.
    """
    with open(input_file, 'r', encoding='utf-8') as infile:
        content = infile.read()

    # Find patterns where two definitions were combined (a period followed by a capitalized term)
    # The pattern is: ". [A-Z][A-Z,a-z]" - a period, space, then capitalized letter
    # Replace ". [CapitalLetter" with ".\n- [CapitalLetter" to split entries
